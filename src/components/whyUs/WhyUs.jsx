...
const WhyUs = () => {
  return (
    ...
    <section
      id="features"
      className="relative block px-6 py-10 md:py-20 md:px-10  border-t  border-[#6BC2B3] bg-white"
    >
      <div className="relative mx-auto max-w-5xl text-center">
        <span className="text-black my-3 flex items-center justify-center font-medium uppercase tracking-wider">
          Why choose us
        </span>
        <h2 className="block w-full  font-bold text-black text-3xl sm:text-4xl">
      ...
      <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-md border border-neutral-800 bg-white p-8 text-center shadow">
          <div
            className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border "
            style={{
              backgroundImage:
                "linearGradient(rgb(80, 70, 229) 0%, rgb(43, 49, 203) 100%) borderColor: rgb(93, 79, 240)",
            }}
          >
            <svg
          ...
          <h3 className="mt-6 text-black">Customizable</h3>
        ...
        <div className="rounded-md border border-neutral-800 bg-white p-8 text-center shadow">
          ...
          <h3 className="mt-6 text-black">Fast Performance</h3>
          <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-black">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linearGradient(rgb(80, 70, 229) 0%, rgb(43, 49, 203) 100%)",
